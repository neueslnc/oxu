...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex align-items-center">
            <div class="ms-auto">
                <a href="{{ route('superadmin.user.create') }}" class="btn btn-primary px-3"><i class="bx bx-plus"></i>Yangi foydalanuvchi qo`shish</a>
            </div>
        </div>
                        ...
                        <table class="table table-bordered align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="fixed_header2 align-middle">Kafedra</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $i => $user)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('superadmin.user.edit',['user'=>$user->id]) }}" class="btn btn-warning px-1"></i>O'zgartirish</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
