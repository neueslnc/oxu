            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('superadmin.user.update',['user'=>$user->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number_phone" name="number_phone" class="form-control" id="number_phone" value="{{ substr($user->number_phone,3) }}">
                            </div>
