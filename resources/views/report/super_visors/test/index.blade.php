...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-body">
            <div class="card">
                <form class="row g-3 p-3">
                    ...
                    <div class="col-md-12">
                        <label for="question_success" class="form-label">Количество правильных вопросов</label>
                        <input class="form-control mb-3" id="question_success_id">
                    </div>
                    <div class="col-md-12">
                        <label for="question_rejerect" class="form-label">Количество неправильных вопросов</label>
        ...
        <div class="modal-footer">
            ...
            <button id="save_change_group" type="button" class="btn btn-primary" onclick="submit_result_exam()">Сохранить</button>
        </div>
        </div>
    </div>
</div>
...
<script src="{{ url('vue/report/super_visors/test/index.js') }}"></script>
...
<script>
    ...
    function get_exam(page = 0){
        $.ajax('{{ route('supervisor_exams.report.filter_test') }}', {
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
            ...
            success: function (data, status) {
                ...
                pagination.current_page = data.page + 1;
    ...
    $("#group_id").on("select2:select", function(e){
        ...
        $.ajax('{{ route('supervisor_exams.report.get_student') }}', {
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
