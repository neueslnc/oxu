...
<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">NB talaba</div>
            <div class="ps-3">
...
<script src="{{ url('vue/report/rektor/nb/index.js') }}"></script>
...
<script>
    ...
    function get_exam(page = 0){
        $.ajax('{{ route('reports.nb.filter_nb') }}', {
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
    ...
    $("#group_id").on("select2:select", function(e){
        $.ajax('{{ route('reports.nb.get_student') }}', {
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
