    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Yangi mavzu</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-10 mx-auto">
                <h6 class="mb-0 text-uppercase">Yangi mavzu yaratish formasi</h6>
                <hr>
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="POST" action="{{ route('theme_subject.store') }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="single-select" id="semester_id" name="semester_id">
                                    <option value="" disabled selected>Semestrni tanlang.</option>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="theme_name" class="form-control" id="theme_name" maxlength="1000">
                            </div>
                            <div class="col-md-12">
                                <label for="theme_text" class="form-label">Maqola matni</label>
                                <textarea class="form-control" id="theme_text" name="theme_text" rows="8"></textarea>
                            </div>
                            <br>
                            <div class="col-12">
