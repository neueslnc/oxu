...
{{--                                    href="{{ route('get.directionGroupSeparately',$students[0]->direction_id) }}">{{ $direction->title }}</a>--}}
{{--                            </li>--}}
        ...
        @enderror
        <form action="{{ route('supervisors.update.allStudent') }}" method="post" enctype="multipart/form-data">
