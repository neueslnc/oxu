            ...
            <div class="card-body">
                <table class="table mb-4 table-striped">
                    ...
                    <tr>
                        ...
                        <th style="font-size: 11px" scope="col"><a class="d-flex align-items-center justify-content-between" href="{{ route('get.directionGroupStudentSeparately',[$direction,$groupp,$course,$type]) }}">F.I.O <i style="font-size: 17px; color: #008cff!important;" class="fadeIn animated bx bx-sort"></i></a></th>
...
{{--                                </td>--}}
                                <td style="font-size: 12px" class="d-flex align-items-center justify-content-between" style="margin-bottom: -1px;">
                                    ...
                                    <div class="dropdown" style="margin-right: 2px; border-radius: 5px">
                                    ...
                                    <a class="btn-sm border-0 btn-primary text-white"
                                       style="outline: none; border-radius: 5px; padding: 3px;"
...
{{--                        @endif--}}
                ...
                <table class="table mb-4 table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col">Transfer guruhi</th>
