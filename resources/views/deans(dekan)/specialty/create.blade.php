                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Mutaxassislik yaratish</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form class="row g-3" method="post" action="{{ route('specialty.store') }}">
                        @csrf
                        <div class="col-md-6">
                            <label for="student_id" class="form-label">Mutaxassislik kodi</label>
                            <input placeholder="Mutaxassislik kodi" type="number" class="form-control" id="student_id" name="code">
                            @error('code')
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="type" class="single-select select2-hidden-accessible" data-select2-id="70" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="col-md-5">
                            <label class="form-label" id="supervisor">Mutaxassislik turi</label>
                            <select name="type_of_education_id" class="single-select select2-hidden-accessible" data-select2-id="7" tabindex="-1" aria-hidden="true">
                                <option value="">Shaklni tanlang</option>
                        ...
                        <div class="col-md-8">
                            ...
                            <input placeholder="Mutaxassislik nomi" type="text" class="form-control " id="hemis_id" name="name">
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
