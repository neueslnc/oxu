    ...
    <div style="margin-left: 260px;margin-right: 20px;" class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Hayfsan</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Hayfsan olganlar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            @foreach($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>{{ $transfer->date }}</td>
                                    <td>
                                        <span class="badge bg-warning text-white shadow-sm w-100">Hayfsan olgan.</span>
                                    </td>
                                </tr>
                                <!-- Modal -->
