    ...
    <div style="margin-left: 260px;margin-right: 20px;" class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Talabalar safidan chiqorish</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Talabalar safidan chiqganlar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            @foreach($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>{{ $transfer->date }}</td>
                                    <td>
                                        <span class="badge bg-danger text-white shadow-sm w-100">Talabalar safidan chiqorilgan</span>
                                    </td>
                                                            ...
                                                            <div class="col-sm-9 text-danger">
                                                                <div class="alert border-0 border-start border-5 border-danger alert-dismissible fade show py-2">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            <h6 class="mb-0 text-danger">Holati</h6>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" style="max-width: 1000px">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" id="status" name="user_id" value="{{$transfer->student->id}}">
                                            </div>
                                            <div class="modal-footer">
