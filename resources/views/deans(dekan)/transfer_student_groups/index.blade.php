                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Transferlar ro'yxati</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <input disabled id="exit_direction_id" type="text" class="form-control" value="{{ $transfer->exit_direction->title }}">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <input type="text" id="transfer_direction_id" disabled class="form-control" value="{{ $transfer->transfer_direction->title }}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Hozirgi guruhi</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Perevod guruhi</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
