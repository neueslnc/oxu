            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('deans_supervisor.index') }}">Nazoratchilar ro'yxati      <i class="bx bx-home-alt"></i></a>
                        </li>
            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('deans_supervisor.store') }}">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="date" name="add_time" class="form-control" id="full_name">
                            </div>
